...
type Enum2 = <E extends Record<string, any>, VK extends Record<string, any>, M extends Record<string, any>>(enumMap: E, valKeyMap?: VK, methodMap?: M) => Enum2Return<E, VK, M>

type Enum2Return<E extends Record<string, any>, VK extends Record<string, any> = { name: number, value: number }, M extends Record<string, any> = any> = {
    keys: string[]
    values: any[]
...
const enum2: Enum2 = <E extends Record<string, any>, VK extends Record<string, any>, M extends Record<string, any>>(enumMap: E, valKeyMap?: VK, methodMap?: M) => {
  const keys: (keyof E)[] = [];
  const valKeyList: (keyof VK)[] = valKeyMap == null ? [] : Object.keys(valKeyMap) as (keyof VK)[];
  const res = {
    keys,
    values: [],
  } as any
